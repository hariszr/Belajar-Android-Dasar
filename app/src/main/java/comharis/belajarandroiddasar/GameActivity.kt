...
class GameActivity : AppCompatActivity() {
    ...
    private fun initComponents() {
        computerImageView = findViewById(R.id.computerIV)
        rockImageButton = findViewById(R.id.rockIB)
        scissorsImageButton = findViewById(R.id.scissorsIB)
        paperImageButton = findViewById(R.id.paperIB)
        resultImageView = findViewById(R.id.resultIV)
    }
